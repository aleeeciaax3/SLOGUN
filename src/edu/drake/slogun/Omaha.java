...
public class Omaha extends Activity implements ActionBar.TabListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_omaha);
		setTitle("");
...
//					startActivity(new Intent(view.getContext(),Omaha.class));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.omaha, menu);
		return true;
	}
	...
	public static class FragmentNew extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewNew.loadUrl("http://slogunapp.appspot.com/app/listing/omaha/new"); //slogunapp.appspot.com/app/listing/new
	...
	public static class FragmentTrending extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewTrending.loadUrl("http://slogunapp.appspot.com/app/listing/omaha/trending"); //slogunapp.appspot.com/app/listing/trending
	...
	public static class FragmentTop extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewTop.loadUrl("http://slogunapp.appspot.com/app/listing/omaha/top"); //slogunapp.appspot.com/app/listing/top
