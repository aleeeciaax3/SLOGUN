...
public class Chicago extends Activity implements ActionBar.TabListener {
...
//					startActivity(new Intent(view.getContext(),Chicago.class));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.chicago, menu);
		return true;
	}
	...
	public static class FragmentNew extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewNew.loadUrl("http://slogunapp.appspot.com/app/listing/chicago/new"); //slogunapp.appspot.com/app/listing/new
			...
			swipeView1.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
				...
				public void onRefresh() {
					...
					if (webViewNew.getUrl().equals("file:///android_asset/connectionerror.html")) {
						webViewNew.loadUrl("http://slogunapp.appspot.com/app/listing/chicago/new");
					}
					else {
						webViewNew.reload();
					}
		...
		public class MyWebViewClient extends WebViewClient {
			...
			public boolean shouldOverrideUrlLoading(WebView view, String url) {
				...
				if (temp.contains("user")) {
					 ...
					 * 
					 */
					((Chicago)getActivity()).goToProfilePage(url);
					 ...
					 * 
					 */
					((Chicago)getActivity()).goToSloganPage(url);
	...
	public static class FragmentTrending extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewTrending.loadUrl("http://slogunapp.appspot.com/app/listing/chicago/trending"); //slogunapp.appspot.com/app/listing/trending
			...
			swipeView2.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
				...
				public void onRefresh() {
					...
					if (webViewTrending.getUrl().equals("file:///android_asset/connectionerror.html")) {
						webViewTrending.loadUrl("http://slogunapp.appspot.com/app/listing/chicago/trending");
					}
					else {
		...
		public class MyWebViewClient extends WebViewClient {
			...
			public boolean shouldOverrideUrlLoading(WebView view, String url) {
				...
				if (temp.contains("user")) {
					 ...
					 * 
					 */
					startActivity(new Intent(view.getContext(),Slogan.class));
					return true; //this should be true to ensure that the page doesn't also open in the parent activity.
				}
				else {
					return false;
	...
	public static class FragmentTop extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewTop.loadUrl("http://slogunapp.appspot.com/app/listing/chicago/top"); //slogunapp.appspot.com/app/listing/top
			...
			swipeView3.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
				...
				public void onRefresh() {
					...
					if (webViewTop.getUrl().equals("file:///android_asset/connectionerror.html")) {
						webViewTop.loadUrl("http://slogunapp.appspot.com/app/listing/chicago/top");
					}
					else {
						webViewTop.reload();
					}
