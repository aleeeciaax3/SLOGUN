...
public class CurrentEvents extends Activity implements ActionBar.TabListener {
...
//					startActivity(new Intent(view.getContext(),CurrentEvents.class));
	...
	public static class FragmentNew extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewNew.loadUrl("http://slogunapp.appspot.com/app/listing/current-events/new"); //slogunapp.appspot.com/app/listing/new
			...
			swipeView1.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
				...
				public void onRefresh() {
					...
					if (webViewNew.getUrl().equals("file:///android_asset/connectionerror.html")) {
						webViewNew.loadUrl("http://slogunapp.appspot.com/app/listing/current-events/new");
					}
					else {
						webViewNew.reload();
					}
	...
	public static class FragmentTrending extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewTrending.loadUrl("http://slogunapp.appspot.com/app/listing/current-events/trending"); //slogunapp.appspot.com/app/listing/trending
			...
			swipeView2.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
				...
				public void onRefresh() {
					...
					if (webViewTrending.getUrl().equals("file:///android_asset/connectionerror.html")) {
						webViewTrending.loadUrl("http://slogunapp.appspot.com/app/listing/current-events/trending");
					}
					else {
	...
	public static class FragmentTop extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewTop.loadUrl("http://slogunapp.appspot.com/app/listing/current-events/top"); //slogunapp.appspot.com/app/listing/top
			...
			swipeView3.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
				...
				public void onRefresh() {
					...
					if (webViewTop.getUrl().equals("file:///android_asset/connectionerror.html")) {
						webViewTop.loadUrl("http://slogunapp.appspot.com/app/listing/current-events/top");
					}
					else {
						webViewTop.reload();
					}
