...
public class Midwest extends Activity implements ActionBar.TabListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_midwest);
		setTitle("");
...
//					startActivity(new Intent(view.getContext(),Midwest.class));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.midwest, menu);
		return true;
	}
	...
	public static class FragmentNew extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewNew.loadUrl("http://slogunapp.appspot.com/app/listing/midwest/new"); //slogunapp.appspot.com/listing/new
			...
			swipeView1.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
				...
				public void onRefresh() {
					...
					if (webViewNew.getUrl().equals("file:///android_asset/connectionerror.html")) {
						webViewNew.loadUrl("http://slogunapp.appspot.com/app/listing/midwest/new");
					}
					else {
						webViewNew.reload();
					}
	...
	public static class FragmentTrending extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewTrending.loadUrl("http://slogunapp.appspot.com/app/listing/midwest/trending"); //slogunapp.appspot.com/listing/trending
			...
			swipeView2.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
				...
				public void onRefresh() {
					...
					if (webViewTrending.getUrl().equals("file:///android_asset/connectionerror.html")) {
						webViewTrending.loadUrl("http://slogunapp.appspot.com/app/listing/midwest/trending");
					}
					else {
	...
	public static class FragmentTop extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewTop.loadUrl("http://slogunapp.appspot.com/app/listing/midwest/top"); //slogunapp.appspot.com/listing/top
			...
			swipeView3.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
				...
				public void onRefresh() {
					...
					if (webViewTop.getUrl().equals("file:///android_asset/connectionerror.html")) {
						webViewTop.loadUrl("http://slogunapp.appspot.com/app/listing/midwest/top");
					}
					else {
						webViewTop.reload();
					}
