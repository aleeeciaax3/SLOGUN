...
public class DesMoines extends Activity implements ActionBar.TabListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_des_moines);
		setTitle("");
...
//					startActivity(new Intent(view.getContext(),DesMoines.class));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.des_moines, menu);
		return true;
	}
	...
	public static class FragmentNew extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewNew.loadUrl("http://slogunapp.appspot.com/app/listing/des-moines/new"); //slogunapp.appspot.com/app/listing/new
	...
	public static class FragmentTrending extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			webViewTrending.loadUrl("http://slogunapp.appspot.com/app/listing/des-moines/trending"); //slogunapp.appspot.com/app/listing/trending
