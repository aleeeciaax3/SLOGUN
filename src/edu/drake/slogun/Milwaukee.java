...
public class Milwaukee extends Activity implements ActionBar.TabListener {
...
//					startActivity(new Intent(view.getContext(),Milwaukee.class));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.milwaukee, menu);
		return true;
	}
